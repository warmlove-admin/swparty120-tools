...
## 對話開始時請先讀
進度與最近更動都在 Obsidian：`swparty120/swparty120-tools/工作筆記.md`
...
## 工作桌 + 三個家
- 📋 GDrive 工作桌：`H:\我的雲端硬碟\swparty120-tools\`（自動跨電腦同步）
- 🐙 GitHub repo：`warmlove-admin/swparty120-tools`（公開，網頁的家）
- 📘 Obsidian 駕駛艙：`swparty120/swparty120-tools/工作筆記.md`（想法的家）
- 🔥 Firebase 專案：（之後建立時補上）

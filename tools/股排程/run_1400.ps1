...
$LogFile = Join-Path $LogDir ("run_1400_{0}.log" -f (Get-Date -Format "yyyy-MM-dd"))
...
try {
    ...
    & $Python $Script --once --output-label 1400 --skip-non-trading-day --after-close 2>&1 | ForEach-Object {
